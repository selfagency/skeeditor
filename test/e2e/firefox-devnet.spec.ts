...
import { expect, skipIfFirefoxDevnetDisabled, test } from './fixtures/firefox-devnet-extension';
 ...
 */
test('content script injects Edit button for own real devnet post (Firefox)', async ({
  page,
  devnetSession,
  devnetPost,
  routeDevnetBskyApp,
 ...
 */
test('edit button is absent on other users posts (Firefox)', async ({
  page,
  devnetSession,
  devnetPost,
  routeDevnetBskyApp,
 ...
 */
test('edit modal saves real post text to devnet PDS (Firefox)', async ({
  page,
  devnetSession,
  devnetPost,
  routeDevnetBskyApp,
 ...
 */
test('unauthenticated user sees no Edit buttons on devnet post page (Firefox)', async ({
  page,
  devnetPost,
  routeDevnetBskyApp,
}) => {
 ...
 */
test('concurrent edit conflict shows retry prompt (Firefox)', async ({
  page,
  devnetSession,
  devnetPost,
  routeDevnetBskyApp,
