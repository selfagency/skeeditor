...
/** Metadata tag on an atproto record, published by the author within the record. Note that schemas should use #selfLabels, not #selfLabel. */
const selfLabel = l.typedObject<SelfLabel>($nsid, 'selfLabel', l.object({ val: l.string({ maxLength: 128 }) }));
...
const labelValueDefinition = l.typedObject<LabelValueDefinition>(
  ...
  l.object({
    ...
    locales: l.array(l.ref<LabelValueDefinitionStrings>((() => labelValueDefinitionStrings) as any)),
    ...
    defaultSetting: l.optional(l.withDefault(l.string<{ knownValues: ['ignore', 'warn', 'hide'] }>(), 'warn')),
  }),
);
