...
/** Harassment or bullying of minors */
const reasonChildSafetyHarassment = l.token($nsid, 'reasonChildSafetyHarassment');
...
/** Glorification of violence */
const reasonViolenceGlorification = l.token($nsid, 'reasonViolenceGlorification');
...
/** Graphic violent content */
const reasonViolenceGraphicContent = l.token($nsid, 'reasonViolenceGraphicContent');
...
/** Impersonation */
const reasonMisleadingImpersonation = l.token($nsid, 'reasonMisleadingImpersonation');
...
/** Extremist content. These reports will be sent only be sent to the application's Moderation Authority. */
const reasonViolenceExtremistContent = l.token($nsid, 'reasonViolenceExtremistContent');
