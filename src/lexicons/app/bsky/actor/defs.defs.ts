...
const mutedWord = l.typedObject<MutedWord>(
  ...
  l.object({
    ...
    expiresAt: l.optional(l.string({ format: 'datetime' })),
    actorTarget: l.optional(l.withDefault(l.string<{ knownValues: ['all', 'exclude-following'] }>(), 'all')),
  }),
);
...
const statusView = l.typedObject<StatusView>(
  ...
  l.object({
    ...
    embed: l.optional(l.typedUnion([l.typedRef<EmbedExternal.View>((() => EmbedExternal.view) as any)], false)),
    record: l.lexMap(),
...
const preferences = l.array<Preferences[number]>(
  l.typedUnion(
    [
      ...
      l.typedRef<PostInteractionSettingsPref>((() => postInteractionSettingsPref) as any),
...
const profileView = l.typedObject<ProfileView>(
  ...
  l.object({
    ...
    labels: l.optional(l.array(l.ref<LabelDefs.Label>((() => LabelDefs.label) as any))),
    ...
    associated: l.optional(l.ref<ProfileAssociated>((() => profileAssociated) as any)),
    ...
    verification: l.optional(l.ref<VerificationState>((() => verificationState) as any)),
  }),
);
...
const viewerState = l.typedObject<ViewerState>(
  ...
  l.object({
    ...
    mutedByList: l.optional(l.ref<GraphDefs.ListViewBasic>((() => GraphDefs.listViewBasic) as any)),
    blockingByList: l.optional(l.ref<GraphDefs.ListViewBasic>((() => GraphDefs.listViewBasic) as any)),
    knownFollowers: l.optional(l.ref<KnownFollowers>((() => knownFollowers) as any)),
    activitySubscription: l.optional(
      l.ref<NotificationDefs.ActivitySubscription>((() => NotificationDefs.activitySubscription) as any),
    ),
  }),
);
...
const knownFollowers = l.typedObject<KnownFollowers>(
  ...
  l.object({
    count: l.integer(),
    followers: l.array(l.ref<ProfileViewBasic>((() => profileViewBasic) as any), { maxLength: 5, minLength: 0 }),
  }),
);
...
const bskyAppStatePref = l.typedObject<BskyAppStatePref>(
  ...
  'bskyAppStatePref',
  l.object({
    nuxs: l.optional(l.array(l.ref<Nux>((() => nux) as any), { maxLength: 100 })),
    queuedNudges: l.optional(l.array(l.string({ maxLength: 100 }), { maxLength: 1000 })),
    activeProgressGuide: l.optional(l.ref<BskyAppProgressGuide>((() => bskyAppProgressGuide) as any)),
  }),
);
...
const profileAssociated = l.typedObject<ProfileAssociated>(
  ...
  'profileAssociated',
  l.object({
    chat: l.optional(l.ref<ProfileAssociatedChat>((() => profileAssociatedChat) as any)),
    germ: l.optional(l.ref<ProfileAssociatedGerm>((() => profileAssociatedGerm) as any)),
    lists: l.optional(l.integer()),
    labeler: l.optional(l.boolean()),
    feedgens: l.optional(l.integer()),
    starterPacks: l.optional(l.integer()),
    activitySubscription: l.optional(
      l.ref<ProfileAssociatedActivitySubscription>((() => profileAssociatedActivitySubscription) as any),
    ),
  }),
);
...
const verificationState = l.typedObject<VerificationState>(
  ...
  'verificationState',
  l.object({
    verifications: l.array(l.ref<VerificationView>((() => verificationView) as any)),
...
const profileViewDetailed = l.typedObject<ProfileViewDetailed>(
  ...
  l.object({
    ...
    joinedViaStarterPack: l.optional(
      l.ref<GraphDefs.StarterPackViewBasic>((() => GraphDefs.starterPackViewBasic) as any),
    ),
  }),
);
  ...
  l.object({
    threadgateAllowRules: l.optional(
      l.array(
        l.typedUnion(
          [
            l.typedRef<FeedThreadgate.MentionRule>((() => FeedThreadgate.mentionRule) as any),
            l.typedRef<FeedThreadgate.FollowerRule>((() => FeedThreadgate.followerRule) as any),
            l.typedRef<FeedThreadgate.FollowingRule>((() => FeedThreadgate.followingRule) as any),
            l.typedRef<FeedThreadgate.ListRule>((() => FeedThreadgate.listRule) as any),
          ],
          false,
        ),
        { maxLength: 5 },
    ...
    postgateEmbeddingRules: l.optional(
      l.array(l.typedUnion([l.typedRef<FeedPostgate.DisableRule>((() => FeedPostgate.disableRule) as any)], false), {
        maxLength: 5,
      }),
    ),
  }),
...
const profileAssociatedActivitySubscription = l.typedObject<ProfileAssociatedActivitySubscription>(
  $nsid,
