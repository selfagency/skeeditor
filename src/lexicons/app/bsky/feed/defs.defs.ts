...
const postView = l.typedObject<PostView>(
  ...
  l.object({
    ...
    embed: l.optional(
      l.typedUnion(
        [
          ...
          l.typedRef<EmbedRecordWithMedia.View>((() => EmbedRecordWithMedia.view) as any),
        ],
        false,
      ),
    ),
    author: l.ref<ActorDefs.ProfileViewBasic>((() => ActorDefs.profileViewBasic) as any),
    ...
    threadgate: l.optional(l.ref<ThreadgateView>((() => threadgateView) as any)),
...
const replyRef = l.typedObject<ReplyRef>(
  ...
  l.object({
    ...
    grandparentAuthor: l.optional(l.ref<ActorDefs.ProfileViewBasic>((() => ActorDefs.profileViewBasic) as any)),
  }),
);
...
const feedViewPost = l.typedObject<FeedViewPost>(
  ...
  l.object({
    ...
    reason: l.optional(
      l.typedUnion(
        [l.typedRef<ReasonRepost>((() => reasonRepost) as any), l.typedRef<ReasonPin>((() => reasonPin) as any)],
        false,
      ),
    ),
    feedContext: l.optional(l.string({ maxLength: 2000 })),
...
const reasonRepost = l.typedObject<ReasonRepost>(
  ...
  'reasonRepost',
  l.object({
    by: l.ref<ActorDefs.ProfileViewBasic>((() => ActorDefs.profileViewBasic) as any),
...
const blockedAuthor = l.typedObject<BlockedAuthor>(
  ...
  l.object({
    ...
    viewer: l.optional(l.ref<ActorDefs.ViewerState>((() => ActorDefs.viewerState) as any)),
  }),
);
...
const generatorView = l.typedObject<GeneratorView>(
  ...
  l.object({
    ...
    labels: l.optional(l.array(l.ref<LabelDefs.Label>((() => LabelDefs.label) as any))),
    viewer: l.optional(l.ref<GeneratorViewerState>((() => generatorViewerState) as any)),
    ...
    descriptionFacets: l.optional(l.array(l.ref<RichtextFacet.Main>((() => RichtextFacet.main) as any))),
...
const threadViewPost = l.typedObject<ThreadViewPost>(
  ...
  l.object({
    ...
    threadContext: l.optional(l.ref<ThreadContext>((() => threadContext) as any)),
  }),
);
...
const threadgateView = l.typedObject<ThreadgateView>(
  ...
  l.object({
    cid: l.optional(l.string({ format: 'cid' })),
    uri: l.optional(l.string({ format: 'at-uri' })),
    lists: l.optional(l.array(l.ref<GraphDefs.ListViewBasic>((() => GraphDefs.listViewBasic) as any))),
...
const skeletonReasonPin = l.typedObject<SkeletonReasonPin>($nsid, 'skeletonReasonPin', l.object({}));
