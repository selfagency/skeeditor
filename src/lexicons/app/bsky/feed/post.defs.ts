...
const main = l.record<'tid', Main>(
  ...
  $nsid,
  l.object({
    tags: l.optional(l.array(l.string({ maxLength: 640, maxGraphemes: 64 }), { maxLength: 8 })),
    ...
    embed: l.optional(
      l.typedUnion(
        [
          ...
          l.typedRef<EmbedRecordWithMedia.Main>((() => EmbedRecordWithMedia.main) as any),
        ],
        false,
      ),
    ),
    langs: l.optional(l.array(l.string({ format: 'language' }), { maxLength: 3 })),
    reply: l.optional(l.ref<ReplyRef>((() => replyRef) as any)),
    facets: l.optional(l.array(l.ref<RichtextFacet.Main>((() => RichtextFacet.main) as any))),
