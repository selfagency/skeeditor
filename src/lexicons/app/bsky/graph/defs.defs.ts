...
const starterPackView = l.typedObject<StarterPackView>(
  ...
  l.object({
    ...
    feeds: l.optional(l.array(l.ref<FeedDefs.GeneratorView>((() => FeedDefs.generatorView) as any), { maxLength: 3 })),
    labels: l.optional(l.array(l.ref<LabelDefs.Label>((() => LabelDefs.label) as any))),
    record: l.lexMap(),
    creator: l.ref<ActorDefs.ProfileViewBasic>((() => ActorDefs.profileViewBasic) as any),
    indexedAt: l.string({ format: 'datetime' }),
