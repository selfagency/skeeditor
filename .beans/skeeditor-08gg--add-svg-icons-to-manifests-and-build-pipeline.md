...
Add skeeditor.svg (transparent) and skeeditor_button.svg (solid background) icons to the extension manifests using vite-plugin-render-svg to generate PNGs at required sizes.

## Todo

- [x] Install vite-plugin-render-svg and @resvg/resvg-js and vite-plugin-image-optimizer
...
- Installed `vite-plugin-render-svg`, `@resvg/resvg-js`, and `vite-plugin-image-optimizer` as devDependencies.
